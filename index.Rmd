...
Select:
- A text file (sample available on the master branch at https://github.com/gmuldoon/DataProducts-coursera/tree/master)
...
library(ggplot2)
freq=read.csv('AliceinWonderland-freq.csv')
names(freq)[1]<-paste("word")
names(freq)[2]<-paste("frequency")
